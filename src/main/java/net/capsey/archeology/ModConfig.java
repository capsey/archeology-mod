...
public class ModConfig extends MidnightConfig {
    ...
    @Entry(min=0.0F, max=1.0F, isSlider=true) public static float brushingLayerChance = 0.35F;
    @Client @Entry(min=0.0F, max=1.0F, isSlider=true) public static float brushingLowerThreshold = 0.02F;
    @Client @Entry(min=0.0F,max=20.0F, isSlider=true) public static float brushingBreakingSpeed = 3.0F;
